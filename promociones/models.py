...
class Page(models.Model):
    ...
    name = models.CharField(max_length=255, default="Promociones",  help_text='Título de la webapp. Si ingresas más de un registro, éste se mostrará en forma aleatoria')
...
class PostCard(models.Model):
    ...
    start_day = models.IntegerField(default=1, help_text='Día inicial a partir del cual se comenzará a mostrar el PostCard')
...
class Post(models.Model):
    title = models.CharField(max_length=255, default='Promoción #...')
    ...
    title_tag = models.CharField(max_length=255, default="Promociones", help_text='Título que se muestra arriba en el tab')
